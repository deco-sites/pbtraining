    ...
    return productId && image && description && name && price && url
      ? (
        <div className="flex flex-col justify-center items-center">
          ...
          >
            <div className="w-auto md:w-1/3 ml-3 mr-2 flex justify-center h-min">
            ...
            <div className="flex flex-col justify-normal mt-3 md:mt-0 md:flex-row md:w-2/3 md:max-w-full">
              ...
              <div className="border-l-lime-800 md:border-l ml-3 mr-3 justify-center items-stretch flex flex-col md:items-center md:w-1/3">
